...
class BusinessPartnersCorporateBodyRegistrationNumberControllerSpec
  ...
  val controller =
    new BusinessPartnersCorporateBodyCompanyRegNumberController(commonDependencies, views, mockActions, mockAppConfig)(
      mockMcc)

  "load" should {
    "Render the businessPartnersCorporateBodyRegNumber page" when {
