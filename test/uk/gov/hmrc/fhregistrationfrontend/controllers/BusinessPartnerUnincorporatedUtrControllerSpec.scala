...
class BusinessPartnerUnincorporatedUtrControllerSpec extends ControllerSpecWithGuiceApp with ActionsMock {
  ...
  val controller =
    new BusinessPartnerUnincorporatedUtrController(commonDependencies, views, mockActions, mockAppConfig)(mockMcc)
