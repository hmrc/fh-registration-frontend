...
class BusinessPartnersPartnershipUtrController @Inject()(
  ...
  def load(index: Int, mode: Mode): Action[AnyContent] = dataRequiredAction { implicit request =>
    ...
    Ok(view.business_partners_has_utr(prepopulatedForm, partnerName, businessPartnerType, postAction, backLink))
  }
    ...
    form
      ...
      .fold(
        ...
        businessPartnersUtr => {
          ...
          val nextPage = routes.BusinessPartnersPartnershipRegisteredAddressController.load()
