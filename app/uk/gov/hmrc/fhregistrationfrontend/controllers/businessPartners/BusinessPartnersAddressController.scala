...
import uk.gov.hmrc.fhregistrationfrontend.forms.businessPartners.BusinessPartnersUkAddressLookupForm.{postcodeKey, businessPartnersUkAddressLookupForm => form}
