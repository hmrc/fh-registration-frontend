...
import uk.gov.hmrc.fhregistrationfrontend.forms.businessPartners.BusinessPartnersEnterUtrForm.businessPartnersEnterUtrForm
...
class BusinessPartnersCorporateBodyUtrController @Inject()(
  ...
  val postAction = Call(
    method = "POST",
    url = routes.BusinessPartnersCorporateBodyUtrController
      .next()
      .url)
