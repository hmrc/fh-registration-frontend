...
import uk.gov.hmrc.fhregistrationfrontend.forms.businessPartners.BusinessPartnersHasUtrForm.{businessPartnerUtrForm => form}
...
class BusinessPartnersPartnershipUtrController @Inject()(
  ...
  def postAction(index: Int, mode: Mode): Call =
    routes.BusinessPartnersPartnershipUtrController.next(index, mode)
