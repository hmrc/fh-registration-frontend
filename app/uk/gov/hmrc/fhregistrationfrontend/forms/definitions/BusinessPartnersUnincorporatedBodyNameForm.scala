...
import uk.gov.hmrc.fhregistrationfrontend.forms.mappings.Mappings.unincorporatedBodyName
import uk.gov.hmrc.fhregistrationfrontend.forms.models.UnincorporatedBodyName

object BusinessPartnersUnincorporatedBodyNameForm {

  val unincorporatedBodyNameKey = "unincorporatedBodyName_value"
