...
package uk.gov.hmrc.fhregistrationfrontend.forms.BusinessPartnersV2

import play.api.data.Form
import play.api.data.Forms.mapping
import uk.gov.hmrc.fhregistrationfrontend.forms.definitions.BusinessPartnersForm.businessPartnerIndividualKey
...
import uk.gov.hmrc.fhregistrationfrontend.models.formmodel.BusinessPartnerNinoInput

object BusinessPartnerNino {
  ...
  val businessPartnerNinoForm = Form(
    mapping(
      hasNinoMapping,
      ninoMapping
    )(BusinessPartnerNinoInput.apply)(BusinessPartnerNinoInput.unapply)
  )
}
