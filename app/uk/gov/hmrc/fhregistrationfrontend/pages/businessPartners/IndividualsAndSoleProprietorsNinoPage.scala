...
case class IndividualsAndSoleProprietorsNinoPage(index: Int) extends QuestionPage[NationalInsuranceNumber] {

  override def path: JsPath = JsPath \ "businessPartners" \ index.toString \ toString

  override def toString: String = "individualsAndSoleProprietorsNino"
}
