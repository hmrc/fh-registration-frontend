...
class Views @Inject()(
  ...
  val has_eori_new: uk.gov.hmrc.fhregistrationfrontend.views.html.forms.has_eori_new,
  val importing_activities_eori_yes_eori_number_new: uk.gov.hmrc.fhregistrationfrontend.views.html.forms.importing_activities_eori_yes_eori_number_new,
  val importing_activities_eori_yes_goods_new: uk.gov.hmrc.fhregistrationfrontend.views.html.forms.importing_activities_eori_yes_goods_new,
