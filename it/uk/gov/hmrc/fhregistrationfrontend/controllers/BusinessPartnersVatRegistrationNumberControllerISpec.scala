...
class BusinessPartnersVatRegistrationNumberControllerISpec
  ...
  "GET /form/business-partners/partner-vat-registration-number" should {
      ...
      "render the partner-vat-registration-number page" in {
        ...
        WsTestClient.withClient { client =>
          val result = client.url(s"$baseUrl/form/business-partners/partner-vat-registration-number")
  ...
  "POST /form/business-partners/partner-vat-registration-number" when {
