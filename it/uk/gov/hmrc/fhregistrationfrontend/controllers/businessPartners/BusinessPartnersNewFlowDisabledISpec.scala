...
class BusinessPartnersNewFlowDisabledISpec
  ...
  val normalRoutes = List(
    ...
    routes.PartnerTypeController.load(index, NormalMode),
  ...
  val checkRoutes = List(
    ...
    routes.PartnerTypeController.load(index, CheckMode),
    ...
    routes.BusinessPartnersUnincorporatedBodyNameController.load(index, CheckMode),
