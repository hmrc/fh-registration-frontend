        ...
        WsTestClient.withClient { client =>
          ...
          whenReady(result) { res =>
            ...
            page.getElementsByClass("govuk-error-summary").text() must include(
              "There is a problem Enter your contact person's first name " +
        ...
        "return 400" in {
          ...
          WsTestClient.withClient { client =>
            ...
            whenReady(result) { res =>
              ...
              val page = Jsoup.parse(res.body)
              page.getElementsByClass("govuk-error-summary").text() must include(
                "There is a problem Select whether the contact address you want to use is in the UK"
              )
            }
          }
        }
        ...
        "return 400" in {
          ...
          WsTestClient.withClient { client =>
            ...
            whenReady(result) { res =>
              ...
              val page = Jsoup.parse(res.body)
              page.getElementsByClass("govuk-error-summary").text() must include(
                "There is a problem Enter address line 1 Enter the postcode of the address"
              )
            }
          }
        }
        ...
        "return 400" in {
          ...
          WsTestClient.withClient { client =>
            ...
            whenReady(result) { res =>
              ...
              val page = Jsoup.parse(res.body)
              page.getElementsByClass("govuk-error-summary").text() must include(
                "There is a problem Enter address line 1 Enter a country and select from the list"
              )
            }
          }
        }
