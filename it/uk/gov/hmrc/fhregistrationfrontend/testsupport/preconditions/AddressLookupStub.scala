...
case class AddressLookupStub()(implicit builder: PreconditionBuilder) {

  private val address1 = AddressRecord(
    id = "test1",
    1233451L,
    Address(Seq("1 test drive", "testing"), Some("example"), "AA1 2BB", Country("GB", "United Kingdom")),
    "en"
  )
  ...
  private val address2 = AddressRecord(
    id = "test2",
    1233452L,
    Address(Seq("2 test drive", "testing"), Some("example"), "AA1 2BB", Country("GB", "United Kingdom")),
    "en"
  )
  ...
  private val address3 = AddressRecord(
    id = "test3",
    1233453L,
    Address(Seq("3 test drive", "testing"), Some("example"), "AA1 2BB", Country("GB", "United Kingdom")),
    "en"
  )
